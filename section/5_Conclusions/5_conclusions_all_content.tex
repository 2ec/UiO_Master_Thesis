...
% Main findings
    ...
    The experiments in this work have proven the ability of post-hoc explainability models to provide valuable insight into the underlying model with no cost to the explained model's accuracy. 
